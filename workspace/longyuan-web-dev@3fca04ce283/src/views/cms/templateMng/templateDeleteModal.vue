      ...
      <div v-loading="loading">
        ...
        <div class="user-table">
          <el-table :data="list" style="width: 100%">
            <el-table-column prop="name" :label="$t('templateMng.equipmentTemplateName')"></el-table-column>
    ...
    deleteUser: debounce(
      function deleteUser() {
        ...
        this.$api.templateMng
          .deleteTemplates(this.id)
          .then((res) => {
            if (!res || !res.success) {
              this.$msg.error(this.$t('templateMng.failure.deleteTemplates'));
              return;
            }
            this.$msg.success(this.$t('templateMng.success.deleteTemplates'));
            this.handleConfirm();
          })
          .catch((err) => {
            this.$msg(err);
