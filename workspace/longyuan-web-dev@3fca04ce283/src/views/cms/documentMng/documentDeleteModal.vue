      ...
      <div v-loading="loading">
        ...
        <div class="user-table">
          <el-table :data="list" style="width: 100%">
            <el-table-column prop="fileName" :label="$t('documentMng.documentName')"></el-table-column>
            <el-table-column prop="title" :label="$t('documentMng.title')"></el-table-column>
    ...
    deleteGearbox: debounce(
      function deleteDocument() {
        ...
        this.$api.database
          ...
          .then((res) => {
            if (!res || !res.success) {
              this.$msg.error(this.$t('documentMng.deleteDocumentFail'));
              return;
            }
            this.$msg.success(this.$t('documentMng.deleteDocumentSuccess'));
            this.handleConfirm();
          })
          .catch((err) => {
            this.$msg.error(err);
