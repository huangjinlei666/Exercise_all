<template>
  <div id="productTemplate-delete-modal">
    <el-dialog
      :title="options.title"
      ...
      <div v-loading="loading">
        ...
        <div class="user-table">
          <el-table :data="list" style="width: 100%">
            <el-table-column prop="name" :label="$t('productTemplate.productTemplateName')"></el-table-column>
    ...
    deleteUser: debounce(
      function deleteUser() {
        ...
        this.$api.productTemplate
          .deleteProductTemplates(this.id)
          .then((res) => {
            if (!res) {
              this.$msg.error(this.$t('productTemplate.failure.deleteProductTemplate'));
              return;
            }
            this.$msg.success(this.$t('productTemplate.success.deleteProductTemplate'));
            this.handleConfirm();
          })
          .catch((err) => {
            this.$msg.error(err);
